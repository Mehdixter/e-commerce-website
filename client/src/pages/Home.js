					...
					<div className="row justify-content-between">
						<div className="col-lg-5">
							<div className="intro-excerpt">
								...
								<p><NavLink href="" className="btn btn-secondary me-2" to="/Shop">Shop Now</NavLink><NavLink href="#" className="btn btn-white-outline" to="/Shop">Explore</NavLink></p>
							</div>
						</div>
		...
		<div classNameName="blog-section ">
			<div className="container">
				...
				<div className="row">
					...
					<div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div className="post-entry">
							<a href="#" class="post-thumbnail"><img src="images/post-3.jpg" alt="Image" className="img-fluid"/></a>
							<div className="post-content-entry">
